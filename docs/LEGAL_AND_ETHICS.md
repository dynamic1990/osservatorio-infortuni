...
I dataset INAIL open data contengono **record pseudonimizzati a livello di singolo caso**: identificativi interni (caso, infortunato, datore di lavoro, posizione assicurativa), luogo di nascita (codice catastale), età, genere, provincia di accadimento. Non sono dati personali diretti, ma restano dati sensibili nel contesto: il progetto deve trattarli con cura.
...
I dati sono pubblicati così come forniti dagli enti. Errori, ritardi o discontinuità nelle fonti vanno documentati, non corretti silenziosamente.
