...
export const SOURCES: Record<SourceId, SourceInfo> = {
  ...
  "inail-malattie-semestrale": {
    ...
    format: "CSV (download diretto per regione)",
    coverage: "Decessi per malattia professionale riconosciuta (DataDec), per anno di morte 2021-2025",
    frequency: "Semestrale",
    status: "active",
  ...
  "inail-serie-storica": {
    ...
    coverage: "Denunce totali e casi mortali nazionali 2014-2019 (serie storica ufficiale); microdati 2020-2025",
    frequency: "Annuale",
    status: "active",
    notes: "Serie consolidata per la vista storica; il dato 2020 include i casi COVID riconosciuti come infortunio",
  },
  "eurostat-esaw": {
    id: "eurostat-esaw",
