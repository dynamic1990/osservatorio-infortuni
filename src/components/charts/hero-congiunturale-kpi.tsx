    ...
    <div style={{ display: "grid", gap: "var(--space-4)" }}>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "0.82rem", marginTop: "var(--space-1)", color: "var(--color-text-soft)" }}>
            ...
            <span
              style={{
                fontWeight: 700,
                color: kpiMod.delta > 0 ? "var(--color-accent)" : "var(--color-success)",
              }}
            >
        ...
        >
          ...
          <div style={{ fontSize: "0.82rem", marginTop: "var(--space-1)", color: "var(--color-text-soft)" }}>
            ...
            <span
              style={{
                fontWeight: 700,
                color: mortali.delta <= 0 ? "var(--color-success)" : "var(--color-accent)",
              }}
            >
        ...
        >
          ...
          <div style={{ fontSize: "0.82rem", marginTop: "var(--space-1)", color: "var(--color-text-soft)" }}>
            ...
            <span
              style={{
                fontWeight: 700,
                color: deltaMedia <= 0 ? "var(--color-success)" : "var(--color-accent)",
              }}
            >
        ...
        >
          ...
          <div style={{ fontSize: "0.82rem", marginTop: "var(--space-1)", color: "var(--color-text-soft)" }}>
            vs {inc25} nel 2025 (
            <span style={{ fontWeight: 700, color: Number(deltaInc) > 0 ? "var(--color-accent)" : "var(--color-success)" }}>
