...
import { BookOpen, CircleDollarSign, Cross, ExternalLink, FileText, Home, Menu, Newspaper, UserSearch, Workflow, X } from "lucide-react";
...
const VOCI = [
  ...
  { href: "/report", label: "Report", icon: Newspaper, group: "Strumenti" },
